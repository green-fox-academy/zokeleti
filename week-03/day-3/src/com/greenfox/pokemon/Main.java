...
public class Main {
    public static void main(String[] args) {
        ...
        String pokemonToChoose = "There's no appropriate pokemon you have";

        for (Pokemon pokemon : pokemonOfAsh){
            if(pokemon.isEffectiveAgainst(wildPokemon)){
                pokemonToChoose = pokemon.name;
            }
        }

        System.out.print("I choose you, " + pokemonToChoose);
    }
